...
from config.state_vec import STATE_VEC_IDX_MAPPING
...
class HDF5VLADataset:
    ...
    def __init__(self, config) -> None:
        ...
        HDF5_DIR = config.dataset.hdf5_dir#"data/datasets/agilex/rdt_data/"
    ...
    def parse_hdf5_file(self, file_path):
        ...
        with h5py.File(file_path, 'r') as f:
            ...
            if "xtrainer" in file_path:
                instruction = "Place the bottled laundry detergent and the pouch laundry detergent into the cardboard box."
